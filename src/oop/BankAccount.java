...
public class BankAccount implements IRate{
	...
	void withdraw(double amount) {
		if(balance < amount) {
			double current = amount - (balance * 0.45);
			System.out.println("Your Current Balance is $"+balance +" you can only withdraw $"+current);
		}else {
			balance = balance - amount;
		System.out.println("Your Current Balance is $"+balance +" amount withdraw is $"+amount);
